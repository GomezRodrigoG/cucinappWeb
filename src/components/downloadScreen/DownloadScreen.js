...
export const DownloadScreen = () => {
    return (
        <div 
            className="downloadScreen__container"
        >
            <Title
                title="Comenzá ahora. "
                span={ <span className="general__blackText">ES GRATIS</span> }
                customClassName="general__title customSizeTitle"
            />
            <div
                data-aos="fade-right"
                className="downloadScreen__textAndButton"
            >
                ...
                <a href={ urlDownloadApp } target="_blank" rel="noreferrer">
                    <div
